...
class PurchaseReturnDetail extends StatefulWidget {
  ...
  PurchaseReturnDetail({Key? key, @required this.FBillNo, @required this.tranType})
      : super(key: key);

  @override
  _PurchaseReturnDetailState createState() =>
      _PurchaseReturnDetailState(FBillNo, tranType);
}
