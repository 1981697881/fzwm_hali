...
class PurchaseWarehousingPage extends StatefulWidget {
  var tranType;
  PurchaseWarehousingPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _PurchaseWarehousingPageState createState() => _PurchaseWarehousingPageState(tranType);
}
...
class _PurchaseWarehousingPageState extends State<PurchaseWarehousingPage> {
  ...
  _PurchaseWarehousingPageState(tranType) {
