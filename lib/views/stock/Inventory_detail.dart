...
import 'package:fzwm_hali/model/currency_entity.dart';
import 'package:fzwm_hali/model/submit_entity.dart';
import 'package:fzwm_hali/utils/refresh_widget.dart';
import 'package:fzwm_hali/utils/text.dart';
import 'package:fzwm_hali/utils/toast_util.dart';
import 'package:fzwm_hali/views/login/login_page.dart';
...
import 'package:fzwm_hali/components/my_text.dart';
...
class _InventoryDetailState extends State<InventoryDetail> {
  ...
  var tranType;
  var orderNo;
  _InventoryDetailState(FBillNo, tranType) {
    if (FBillNo != null) {
      this.fBillNo = FBillNo['value'];
      this.tranType = FBillNo['id'];
      this.getOrderList();
      isScanWork = true;
    } else {
      isScanWork = false;
  ...
  getOrderList() async {
    ...
    userMap['type'] = 2;*/
    userMap['projectId'] = this.tranType;
    String order = await CurrencyEntity.pollingInvList(userMap);
    ...
    FSaleOrderNoKey.currentState.onPressed(orderDate[0][4]);*/
      ...
      orderDate.forEach((value) {
        ...
        arr.add({
          ...
          "isHide": false,
          "value": {
            "label": value['FName'] + "- (" + value['FItemNumber'].toString() + ")",
        ...
        arr.add({
          ...
          "name": "FUnitId",
          "isHide": false,
          "value": {"label": value['FCUUnitName'], "value": value['FUnitID']}
        });
        arr.add({
          "title": "调拨数量",
          "name": "FRealQty",
        ...
        arr.add({
          ...
          "name": "",
          "isHide": false,
          "value": {"label": value['Fstockname'], "value": value['FStockID']}
        });
        arr.add({
          "title": "账面数量",
          "name": "",
...
*/
      ...
      this.hobby.forEach((element) {
        if (element[3]['value']['value'] != '0' &&
          ...
          FEntityItem['checkQty'] = element[3]['value']['value'];
          FEntityItem['qty'] = element[3]['value']['value'];
          FEntityItem['unitId'] = element[3]['value']['value'];
          FEntityItem['fitemId'] = element[0]['value']['id'];
          FEntityItem['batchNo'] = element[5]['value']['value'];
          FEntityItem['stockId'] = element[4]['value']['value'];
          FEntityItem['stockPlaceId'] = element[6]['value']['value'];
          FEntityItem['projectId'] = this.tranType;
          var fSerialSub = [];
          var fSerialSubIndexOf = [];
          var kingDeeCode = this.hobby[hobbyIndex][0]['value']['kingDeeCode'];
      ...
      String order = await SubmitEntity.saveInv(FEntity);
