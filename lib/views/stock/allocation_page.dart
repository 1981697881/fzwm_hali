...
class AllocationPage extends StatefulWidget {
  var tranType;
  AllocationPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _AllocationPageState createState() => _AllocationPageState(tranType);
}
