...
import 'package:fzwm_hali/http/api_response.dart';
import 'package:fzwm_hali/model/submit_entity.dart';
import 'package:fzwm_hali/model/version_entity.dart';
import 'package:fzwm_hali/utils/SqfLiteQueueDataOffline.dart';
import 'package:fzwm_hali/utils/SqfLiteQueueDataRepertoire.dart';
import 'package:fzwm_hali/utils/SqfLiteQueueDataScheme.dart';
...
class _IndexPageState extends State<IndexPage> {
  ...
  /*getMenuList(value) async{
    String author = await SubmitEntity.permissions(value);
...
/*一个渐变颜色的正方形集合*/
        ...
        return InkWell(
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) {
                    //this.getMenuList(menu[index]['router']);
                    return menu[index]['router'];
                  },
                ),
              );
             /* Navigator.push(
  ...
  Widget buildAppBarTabs() {
    ...
    var menuList = new List<dynamic>.from(jsonDecode(deptData));
      ...
      switch (i['id']) {
        case 1:
          var obj = {
            ...
            "router": MiddleLayerPage(menuId: i['id'], menuTitle: i['name'])
          };
          menu.add(obj);
          break;
        case 2:
