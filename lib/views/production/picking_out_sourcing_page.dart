...
import 'package:fzwm_hali/views/production/picking_out_sourcing_detail.dart';
...
class PickingOutSourcingPage extends StatefulWidget {
  var tranType;
  PickingOutSourcingPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _PickingOutSourcingPageState createState() => _PickingOutSourcingPageState(tranType);
}
...
class _PickingOutSourcingPageState extends State<PickingOutSourcingPage> {
  ...
  _PickingOutSourcingPageState(tranType) {
