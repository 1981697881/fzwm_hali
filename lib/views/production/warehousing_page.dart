...
class WarehousingPage extends StatefulWidget {
  var tranType;
  WarehousingPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _WarehousingPageState createState() => _WarehousingPageState(tranType);
}
...
class _WarehousingPageState extends State<WarehousingPage> {
  ...
  _WarehousingPageState(tranType) {
