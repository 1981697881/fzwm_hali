...
import 'package:fzwm_hali/model/authorize_entity.dart';
import 'package:fzwm_hali/model/currency_entity.dart';
import 'package:fzwm_hali/model/login_entity.dart';
import 'package:fzwm_hali/http/api_response.dart';
import 'package:fzwm_hali/model/submit_entity.dart';
import 'package:fzwm_hali/views/index/index_page.dart';
          ...
          if (_formKey.currentState!.validate()) {
            ...
            if(this.urlContent.text != ''){
              ...
              if (entityRes['success']) {
                ...
                String author = await SubmitEntity.permissions("-1");
                ...
                if (authorRes['success']) {
                  ...
                  for(var authorData in authorRes['data']){
                    String authorChild = await SubmitEntity.permissions(authorData['id'].toString());
