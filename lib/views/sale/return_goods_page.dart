...
class ReturnGoodsPage extends StatefulWidget {
  var tranType;
  ReturnGoodsPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _ReturnGoodsPageState createState() => _ReturnGoodsPageState(tranType);
}
...
class _ReturnGoodsPageState extends State<ReturnGoodsPage> {
  ...
  _ReturnGoodsPageState(tranType) {
    ...
    if (orderDate.length > 0) {
      orderDate.forEach((value) {
        ...
        arr.add({
          ...
          "name": "FSaleOrgId",
          "isHide": false,
          "value": {"label": value["FCustName"], "value": value["FCustName"]}
        });
        arr.add({
          "title": "单据日期",
          "name": "FDate",
