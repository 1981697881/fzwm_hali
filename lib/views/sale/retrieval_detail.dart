...
class RetrievalDetail extends StatefulWidget {
  ...
  RetrievalDetail({Key? key, @required this.FBillNo, @required this.tranType}) : super(key: key);

  @override
  _RetrievalDetailState createState() => _RetrievalDetailState(FBillNo, tranType);
}
...
class _RetrievalDetailState extends State<RetrievalDetail> {
  ...
  _RetrievalDetailState(FBillNo, tranType) {
